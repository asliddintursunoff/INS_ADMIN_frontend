    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        <div className="p-8 space-y-6 flex flex-col max-h-[90vh]">
          <DialogHeader className="p-0 border-b pb-6 bg-transparent">
            ...
            <div className="space-y-6 pb-4">
              {isLoading ? (
                ...
                <div className="py-20 text-center bg-red-50 rounded-2xl border border-red-100">
                  ...
                  <p className="text-slate-500 max-w-xs mx-auto mt-2 font-medium">We couldn't retrieve the attendance data.</p>
                  <Button variant="outline" className="mt-8 rounded-xl font-bold" onClick={onClose}>Close Modal</Button>
                </div>
              ) : selectedEnrollment ? (
                <>
                  <div className="grid grid-cols-3 gap-6 mt-4">
                    <div className="rounded-xl border bg-slate-50 p-6 text-center shadow-sm transition-all hover:border-green-200 hover:bg-green-50/30 group">
                    ...
                    <div className="rounded-xl border bg-slate-50 p-6 text-center shadow-sm transition-all hover:border-red-200 hover:bg-red-50/30 group">
                    ...
                    <div className="rounded-xl border bg-slate-50 p-6 text-center shadow-sm transition-all hover:border-yellow-200 hover:bg-yellow-50/30 group">
                  ...
                  <div className="mt-6 border rounded-xl bg-white p-4 shadow-sm">
